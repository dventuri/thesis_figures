...
pos, var = readData('CVaras2017_riser/data/4w_05_case01_solVolFrac_l3.curve',
                    0.07,1)
ax[0].plot(pos, var,
        color='black',
        linewidth=1,
...
pos, var = readData('CVaras2017_riser/data/4w_06_case01_solVolFrac_l3.curve',
                    0.07,1)
ax[0].plot(pos, var,
        color='black',
        linewidth=1,
...
pos, var = readData('CVaras2017_riser/data/4w_07_case01_solVolFrac_l3.curve',
                    0.07,1)
ax[0].plot(pos, var,
        color='black',
        linewidth=1,
...
pos, var = readData('CVaras2017_riser/data/4w_05_case01_solVolFrac_l2.curve',
                    0.07,1)
ax[1].plot(pos, var,
        color='black',
        linewidth=1,
        linestyle='-')
pos, var = readData('CVaras2017_riser/data/4w_06_case01_solVolFrac_l2.curve',
                    0.07,1)
ax[1].plot(pos, var,
        color='black',
        linewidth=1,
        linestyle='-.')
pos, var = readData('CVaras2017_riser/data/4w_07_case01_solVolFrac_l2.curve',
                    0.07,1)
ax[1].plot(pos, var,
        color='black',
        linewidth=1,
...
pos, var = readData('CVaras2017_riser/data/4w_05_case01_solVolFrac_l1.curve',
                    0.07,1)
ax[2].plot(pos, var,
        color='black',
        linewidth=1,
        linestyle='-')
pos, var = readData('CVaras2017_riser/data/4w_06_case01_solVolFrac_l1.curve',
                    0.07,1)
ax[2].plot(pos, var,
        color='black',
        linewidth=1,
        linestyle='-.')
pos, var = readData('CVaras2017_riser/data/4w_07_case01_solVolFrac_l1.curve',
                    0.07,1)
ax[2].plot(pos, var,
        color='black',
        linewidth=1,
...
#
fig.tight_layout(pad=0.01)
plt.savefig('CVaras2017_riser/CVaras2017_riser_casesLowEta_allHeights_formulation_solVolFrac.pdf',
            format='pdf')
...
pos, var = readData('CVaras2017_riser/data/4w_05_case01_solHold',
                    1,1)
ax.plot(var, pos,
        color='black',
        linewidth=1,
        linestyle='-',
        label='Dense formulation')
pos, var = readData('CVaras2017_riser/data/4w_06_case01_solHold',
                    1,1)
ax.plot(var, pos,
        color='black',
        linewidth=1,
        linestyle='-.',
        label='Dilute formulation')
pos, var = readData('CVaras2017_riser/data/4w_07_case01_solHold',
                    1,1)
ax.plot(var, pos,
        color='black',
        linewidth=1,
...
#
fig.tight_layout(pad=0.01)
plt.savefig('CVaras2017_riser/CVaras2017_riser_casesLowEta_solHoldup.pdf',
            format='pdf')
